...
class MainUI(QMainWindow):
    ...
    def __init__(self):
        ...
        #self.protons.clicked.connect(self.unitsToProtons)
    ...
    def set_up_canvases(self):
        self.canvas1.set_xlabel("Time")
        self.canvas1.set_ylabel("Volts")
        self.canvas1.set_label("BLM")
        self.canvas1.set_grid()
        self.canvas2.set_label("R5IM")
        self.canvas2.set_ylabel("Volts")
    ...
    def repeater(self):
        ...
        self.timer.timeout.connect(self.unitsToProtons)
        self.timer.start()


    def draw_data_volts(self):
    ...
    def unitsToProtons(self):
        #converting to protons
        r5imCoef = 4E12
        if self.volts.isChecked():
            self.draw_data_volts()
